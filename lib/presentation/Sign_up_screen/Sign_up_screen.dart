...
//                         ),
//                         Padding(
//                           padding: EdgeInsets.only(right: MediaQuery.of(context).size.width * 0.30,top: MediaQuery.of(context).size.width * 0.06),
//                           child: Text(
//                             "kavach",
//                             style: TextStyle(fontSize: MediaQuery.of(context).size.width * 0.058, color: Color(0xFF4C2559),fontFamily: 'kalam',fontWeight: FontWeight.w900),
//                           ),
//                         ),
//                       ],
//                     ),
