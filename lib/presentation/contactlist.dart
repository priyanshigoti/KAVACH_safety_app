...
//     String userId = AuthService().getCurrentUser()?.uid ?? '';
//     if (userId.isNotEmpty) {
//       DocumentSnapshot document = await ContactManager().getUserContacts(userId).first;
//       List<dynamic> contacts = document['contacts'];
//       bool contactExists = contacts.any((contactData) =>
//       contactData['displayName'] == contact.displayName &&
//           contactData['phoneNumber'] == contact.phones?.first.value);
//       if (!contactExists) {
...
//         });
//       } else {
//         _showDuplicateContactDialog(context);
//       }
//     }
//   }
//
//   void _showDuplicateContactDialog(BuildContext context) {
//     showDialog(
//       context: context,
//       builder: (BuildContext context) {
//         return AlertDialog(
//           title: Text('Contact'),
//           content: Text('This contact already exists in the list.'),
//           actions: <Widget>[
//             ElevatedButton(
//               style: ElevatedButton.styleFrom(
//                 shape: RoundedRectangleBorder(
